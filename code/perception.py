...
def color_rocks(img, rgb_thresh=(130, 100, 60)):
...
def perception_step(Rover):
    ...
    x_r, y_r = rover_coords(rocks)
    xpix_r, ypix_r = rock_pix(x_r, y_r) # rock coordinates in rc ref
